...
export declare class Global extends HeyApiClient {
     ...
     * Get health
     *
     * Get health information about the 100XPrompt server.
     */
     ...
     * Get global events
     *
     * Subscribe to global events from the 100XPrompt system using server-sent events.
     */
     ...
     * Dispose instance
     *
     * Clean up and dispose all 100XPrompt instances, releasing all resources.
     */
...
export declare class Project extends HeyApiClient {
     ...
     * List all projects
     *
     * Get a list of projects that have been opened with 100XPrompt.
     */
     ...
     * Get current project
     *
     * Retrieve the currently active project that 100XPrompt is working with.
     */
...
export declare class Pty extends HeyApiClient {
     ...
     * List PTY sessions
     *
     * Get a list of all active pseudo-terminal (PTY) sessions managed by 100XPrompt.
     */
    list<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
...
export declare class Config extends HeyApiClient {
     ...
     * Get configuration
     *
     * Retrieve the current 100XPrompt configuration settings and preferences.
     */
    get<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
     ...
     *
     * Update 100XPrompt configuration settings and preferences.
     */
    update<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        config?: Config2;
...
export declare class Instance extends HeyApiClient {
     ...
     * Dispose instance
     *
     * Clean up and dispose the current 100XPrompt instance, releasing all resources.
     */
...
export declare class Path extends HeyApiClient {
     ...
     * Get paths
     *
     * Retrieve the current working directory and related path information for the 100XPrompt instance.
     */
    get<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
...
export declare class Session extends HeyApiClient {
     ...
     * List sessions
     *
     * Get a list of all 100XPrompt sessions, sorted by most recently updated.
     */
    list<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        start?: number;
     ...
     * Create session
     *
     * Create a new 100XPrompt session for interacting with AI assistants and managing conversations.
     */
    create<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        parentID?: string;
     ...
     * Get session
     *
     * Retrieve detailed information about a specific 100XPrompt session.
     */
    get<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        directory?: string;
...
export declare class Command extends HeyApiClient {
     ...
     * List commands
     *
     * Get a list of all available commands in the 100XPrompt system.
     */
    list<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
...
export declare class App extends HeyApiClient {
     ...
     * List agents
     *
     * Get a list of all available AI agents in the 100XPrompt system.
     */
...
export declare class X100PromptClient extends HeyApiClient {
    static readonly __registry: HeyApiRegistry<X100PromptClient>;
    constructor(args?: {
        client?: Client;
        key?: string;
    });
