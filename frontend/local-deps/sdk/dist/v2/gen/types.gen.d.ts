...
export type EventMemoryPhase1Started = {
    type: "memory.phase1.started";
    properties: {
        thread_id: string;
    };
};
export type EventMemoryPhase1Completed = {
    type: "memory.phase1.completed";
    properties: {
        thread_id: string;
        slug: string | null;
    };
};
export type EventMemoryPhase1Failed = {
    type: "memory.phase1.failed";
    properties: {
        thread_id: string;
        error: string;
    };
};
export type EventMemoryPhase2Started = {
    type: "memory.phase2.started";
    properties: {
        [key: string]: unknown;
    };
};
export type EventMemoryPhase2Completed = {
    type: "memory.phase2.completed";
    properties: {
        memories_processed: number;
    };
};
export type EventMemoryPhase2Failed = {
    type: "memory.phase2.failed";
    properties: {
        error: string;
    };
};
export type EventMemoryEntityAdded = {
    type: "memory.entity.added";
    properties: {
        id: string;
        name: string;
        type: string;
...
export type EventMemoryRelationAdded = {
    type: "memory.relation.added";
    properties: {
        from: string;
        to: string;
        type: string;
...
export type EventMemoryStarted = {
    type: "memory.started";
    properties: {
        [key: string]: unknown;
    };
};
export type EventMemoryUsageRecorded = {
    type: "memory.usage.recorded";
    properties: {
        thread_ids: Array<string>;
    };
};
export type EventMemoryProposed = {
...
export type EventMemoryApproved = {
...
export type Event = EventInstallationUpdated | EventInstallationUpdateAvailable | EventProjectUpdated | EventServerInstanceDisposed | EventLspClientDiagnostics | EventLspUpdated | EventMessageUpdated | EventMessageRemoved | EventMessagePartUpdated | EventMessagePartRemoved | EventSessionStatus | EventSessionIdle | EventMemoryPhase1Started | EventMemoryPhase1Completed | EventMemoryPhase1Failed | EventMemoryPhase2Started | EventMemoryPhase2Completed | EventMemoryPhase2Failed | EventMemoryEntityAdded | EventMemoryRelationAdded | EventMemoryStarted | EventMemoryUsageRecorded | EventMemoryProposed | EventMemoryApproved | EventPermissionAsked | EventPermissionReplied | EventTodoUpdated | EventSessionCompacted | EventQuestionAsked | EventQuestionReplied | EventQuestionRejected | EventFileEdited | EventTuiPromptAppend | EventTuiCommandExecute | EventTuiToastShow | EventTuiSessionSelect | EventMcpToolsChanged | EventCommandExecuted | EventSessionCreated | EventSessionUpdated | EventSessionDeleted | EventSessionDiff | EventSessionError | EventFileWatcherUpdated | EventVcsBranchUpdated | EventPtyCreated | EventPtyUpdated | EventPtyExited | EventPtyDeleted | EventServerConnected | EventGlobalDisposed;
...
/**
 * Server configuration for 100xprompt serve and web commands
 */
