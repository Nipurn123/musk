...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new X100PromptClient()" to fix this error.`)
    }
    return instance
  }
...
export class X100PromptClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<X100PromptClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    X100PromptClient.__registry.set(this, args?.key)
  }
