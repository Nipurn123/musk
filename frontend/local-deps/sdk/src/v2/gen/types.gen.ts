...
export type Event =
  ...
  | EventSessionStatus
  | EventSessionIdle
  | EventMemoryPhase1Started
  | EventMemoryPhase1Completed
  | EventMemoryPhase1Failed
  | EventMemoryPhase2Started
  | EventMemoryPhase2Completed
  | EventMemoryPhase2Failed
  | EventMemoryEntityAdded
  | EventMemoryRelationAdded
  | EventMemoryStarted
  | EventMemoryUsageRecorded
  | EventMemoryProposed
  | EventMemoryApproved
